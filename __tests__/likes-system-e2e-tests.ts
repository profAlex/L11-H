...
describe("Test API for liking/disliking comments", () => {
    ...
    it("PUT /comments/:{commentId}/like-status -  test base entries, directly without endpoint calls", async () => {
        const loginCreds = {
        ...
        expect(gettingCommentRes_2.body.likesInfo).toHaveProperty("dislikesCount");
